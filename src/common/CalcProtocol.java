 ...
 */
public interface CalcProtocol {
    public static String LOGIN = "user name";
    public static String LOGIN_ACCEPTED = "Logged in";
    public static String ROLE = "next will be role";
